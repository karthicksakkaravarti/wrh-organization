            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-combobox v-model="record.tags" :items="$store.state.sitePrefs.site_ui__event_tags || []" dense outlined hide-details label="Tags" clearable multiple small-chips deletable-chips></v-combobox>
                  </v-col>
                  <v-col cols="12" md="4">
